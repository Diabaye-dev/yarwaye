/**
 * ROUTE /api/analytics — indicateurs de performance
 * 
 * Agrège en base tout ce qu'affiche l'écran "Marges & rapports" :
 * chiffre d'affaires global et du jour, marge brute estimée, valeur du stock
 * (au coût et au prix de vente), créances clients, répartition des modes de
 * paiement, top 5 des ventes et dernières alertes de stock.
 */
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ error: "Impossible de générer les statistiques" }, { status: 500 });
  }
}
