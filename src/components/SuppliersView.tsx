"use client";
/**
 * VUE "Fournisseurs" — src/components/SuppliersView.tsx
 * 
 * Cartes des fournisseurs avec recherche, catégories de marchandises, notes,
 * appel téléphonique direct et actions d'édition / suppression.
 */
