"use client";
/**
 * FENÊTRE "Client" — src/components/CustomerModal.tsx
 * 
 * Formulaire modal réutilisable de création / modification d'un client
 * (coordonnées, adresse, solde de dette, notes). Détecte le mode grâce à la
 * prop "customer" : POST /api/customers en création, PUT en modification.
 */
