"use client";
/**
 * FENÊTRE "Fournisseur" — src/components/SupplierModal.tsx
 * 
 * Création / modification d'un partenaire d'approvisionnement : raison
 * sociale, interlocuteur, téléphone, e-mail, adresse, marchandises fournies
  ...
  useEffect(() => {
    if (supplier) {
      ...
      setFormData({
        ...
        email: "",
        address: "",
        categories: "Alimentation, Électronique",
        notes: "",
      });
    }
    setError(null);
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Ex: Coopérative Agricole de Malika..."
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Électronique, Riz, etc."
                className="w-full px-3 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:outline-hidden"
              />
            </div>
          </div>
