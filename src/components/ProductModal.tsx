"use client";
/**
 * FENÊTRE "Produit" — src/components/ProductModal.tsx
 * 
 * Formulaire de création / modification d'un article du catalogue :
 * désignation, SKU, code-barres, catégorie, prix d'achat, prix de vente,
 * stock, seuil d'alerte, unité, image, visibilité. Génère un SKU si vide.
 */
...
const PRESET_IMAGES = [
  { label: "Riz / Céréales", url: "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=500&auto=format&fit=crop&q=80" },
  { label: "Huile / Transformation", url: "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=500&auto=format&fit=crop&q=80" },
  { label: "Légumes frais", url: "https://images.unsplash.com/photo-1540420773420-3366772f4999?w=500&auto=format&fit=crop&q=80" },
  { label: "Pâtisserie", url: "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=500&auto=format&fit=crop&q=80" },
  { label: "Restauration", url: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=500&auto=format&fit=crop&q=80" },
  { label: "BTP / Chantier", url: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=500&auto=format&fit=crop&q=80" },
  { label: "Agriculture", url: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=500&auto=format&fit=crop&q=80" },
];
...
export function ProductModal({ isOpen, onClose, product, onSaved }: ProductModalProps) {
  ...
  useEffect(() => {
    if (product) {
      ...
      setFormData({
        name: "",
        sku: `YAR-${Math.floor(1000 + Math.random() * 9000)}`,
        barcode: "",
        category: "Produits Agricoles",
        description: "",
        costPrice: 0,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                placeholder="Ex: Sac de Riz 25kg, Huile d'arachide, Ciment..."
