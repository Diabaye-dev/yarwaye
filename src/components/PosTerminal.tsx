...
/* ============================================================================
 *  FICHIER : src/components/PosTerminal.tsx
 *  LANGAGE : TypeScript + JSX (React)
 *  RÔLE    : Le TERMINAL DE POINT DE VENTE (POS) — l'écran de caisse
 *            utilisé par le personnel au comptoir pour encaisser vite.
 *
 *  Deux grandes zones côte à côte :
 *    GAUCHE  → le catalogue : recherche instantanée, onglets de catégories,
 *              grille de produits cliquables avec miniatures et stock
 *    DROITE  → le ticket de caisse : sélection du client, lignes du panier,
 *              sous-total, remise, choix du paiement (Espèces, Wave/OM
 *              767866536, Carte, Crédit), et bouton d'encaissement
 *
 *  Au moment de l'encaissement (handleCheckout) :
 *    - on envoie la commande à l'API /api/orders
 *    - l'API décrémente automatiquement les stocks
 *    - le ticket de caisse imprimable s'ouvre (ReceiptModal)
 * ==========================================================================*/
...
export function PosTerminal({
  ...
  const handleCheckout = async () => {
    ...
    const payload = {
      ...
      cashierName: user?.name || "Yarwaye Staff",
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 h-full">
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs space-y-3">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Rechercher par nom, SKU ou code-barres (ex: maïs, farine, ciment, 6101...)..."
      ...
      {/* Right Column: Checkout Terminal & Cart */}
