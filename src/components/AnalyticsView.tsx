...
/* ============================================================================
 *  FICHIER : src/components/AnalyticsView.tsx
 *  LANGAGE : TypeScript + JSX (React)
 *  RÔLE    : L'écran "Marges & Rapports" — la page des STATISTIQUES.
 *
 *  Au chargement, elle interroge GET /api/analytics pour afficher :
 *    - Chiffre d'affaires global et du jour
 *    - Marge brute réalisée et valeur du stock (coût vs revente)
 *    - Créances clients (dettes à recouvrer)
 *    - Répartition des paiements (espèces, Wave/OM 767866536, carte, crédit)
 *    - Top 5 des meilleures ventes
 *    - Journal d'audit des mouvements de stock (entrées, ventes, ajustements)
 * ==========================================================================*/
