"use client";
/**
 * VUE "Ventes & commandes" — src/components/OrdersView.tsx
 * 
 * Tableau filtrable de toutes les ventes (recherche, statut, mode de
 * paiement). Actions : imprimer le reçu, ouvrir le détail des lignes,
 * annuler/rembourser une vente (le stock est rendu automatiquement).
 */
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Total {orders.length} transactions enregistrées chez AGRO SERVICE YARWAYE (Assistance: {storePhone})
          </p>
        </div>
