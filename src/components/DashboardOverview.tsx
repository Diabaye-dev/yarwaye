"use client";
/**
 * TABLEAU DE BORD — src/components/DashboardOverview.tsx
 * 
 * Écran d'accueil du gérant : bandeau contact 767866536, 4 indicateurs clés
 * (ventes du jour, CA global, alertes stock, créances), raccourcis d'actions,
 * dernières ventes avec impression du ticket et panneau de réassort.
 */
...
export function DashboardOverview({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Assistance Announcement Banner */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-emerald-100/90 mt-0.5">
              Ligne directe, Wave et Orange Money :{" "}
              <strong className="text-white underline font-mono text-sm">{storePhone}</strong> • Malika / Keur Massar, Dakar
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/90 shadow-xs hover:shadow-md transition-all">
          ...
          <div className="mt-2 text-[11px] text-slate-500 flex items-center justify-between">
            ...
            <span className="text-emerald-700 font-bold flex items-center">
              <ArrowUpRight className="w-3.5 h-3.5" /> En direct
            </span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        >
          ...
          <div>
            <div className="font-bold text-xs text-slate-900">Nouveau ticket de caisse</div>
            <div className="text-[10px] text-slate-400">Encaisser une vente</div>
          </div>
        </button>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-slate-900 to-teal-950 text-white rounded-2xl p-6 shadow-md space-y-3">
            ...
            <p className="text-xs text-slate-300">
              Assistance, WhatsApp et encaissements Wave / Orange Money sur le numéro officiel :
            </p>
