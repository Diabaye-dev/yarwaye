"use client";
/**
 * FENÊTRE "Changer de session" — src/components/UserSwitchModal.tsx
 * 
 * Onglet 1 : sélection d'un membre du personnel pour incarner sa session
 *            (utile pour tester les rôles propriétaire / gérant / caissier).
 * Onglet 2 : création d'un nouveau membre (POST /api/auth, action register).
 */
            ...
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="babacar@yarwaye.sn"
                  className="w-full px-3 py-2 text-xs border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:outline-hidden"
                />
              </div>
